...
class MyTasksView(APIView):
    ...
    def get(self, request):
        try:
            result = TaskService.list_my_tasks(user=request.user, params=request.query_params)
            ...
            logger.exception("Database error while listing assigned tasks.")
        except Exception:
            logger.exception("Unexpected error while listing assigned tasks.")
        return Response(
