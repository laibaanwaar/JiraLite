    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          {projects.slice(0, 4).map((project, index) => {
            ...
            return (
              <article
                ...
                className={`flex items-center justify-between gap-3 rounded-2xl py-1 transition ${
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <h3 className="truncate text-base font-extrabold text-slate-900">{project.name || 'Untitled Project'}</h3>
      ...
      {!showProjectsLink && canViewAllProjects ? (
        <button
          type="button"
          onClick={onViewAllProjects}
          className="mt-5 text-sm font-extrabold text-[#4b36f4] transition hover:text-[#3726c9]"
        >
          View all projects
        </button>
      ) : null}
